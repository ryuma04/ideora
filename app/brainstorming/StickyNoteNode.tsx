...
export default memo(function StickyNoteNode({ id, data, isConnectable }: any) {
    ...
    return (
        <div className={`relative w-48 h-48 shadow-lg ${bgColor} border-t-[12px] ${borderColor} flex flex-col items-center justify-start p-3 transition-transform hover:-translate-y-1 hover:shadow-2xl rounded-b-md`}>
